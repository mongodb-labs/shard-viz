...
function getChunks(host, success, failure, cmdError, notFound, serverError) {
    queryDB(('http://' + host[0] + ':' + host[1] + '/config/chunks/?limit=0'), host[2], host[3], success, failure, cmdError, notFound, serverError);
};
...
function getChangelog(host, success, failure, cmdError, notFound, serverError) {
    queryDB(('http://' + host[0] + ':' + host[1] + '/config/changelog/?limit=0'), host[2], host[3], success, failure, cmdError, notFound, serverError);
};
